...
import { R_SHIPPING, ROLEX_CTA_LABEL } from "@/lib/rolex-content";

export function RolexShipping(): React.ReactElement {
  return (
    <section id="shipping-security" className="bg-[var(--color-cream)] py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-5 md:px-8">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          ...
          <Reveal delay={100}>
            <p className="eyebrow">{R_SHIPPING.eyebrow}</p>
