...
import { R_TWO_OPTIONS, ROLEX_QUOTE_ANCHOR, ROLEX_CTA_LABEL } from "@/lib/rolex-content";

export function RolexTwoOptions(): React.ReactElement {
  return (
    <section id="two-options" className="bg-white py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-5 md:px-8">
        <Reveal className="max-w-3xl">
          <p className="eyebrow">{R_TWO_OPTIONS.eyebrow}</p>
          <h2 className="mt-3 font-display text-[2.25rem] leading-[1.08] text-[var(--color-ink)] md:text-5xl">
            {R_TWO_OPTIONS.headline}
          </h2>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          {R_TWO_OPTIONS.cards.map((card, i) => (
