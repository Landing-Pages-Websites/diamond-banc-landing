...
import { ROLEX_QUOTE_ANCHOR, ROLEX_CTA_LABEL } from "@/lib/rolex-content";
...
export function RolexFloatingCTA(): React.ReactElement {
  const formInView = useElementVisibility(ROLEX_QUOTE_ANCHOR);
