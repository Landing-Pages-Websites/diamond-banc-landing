...
import { ROLEX_CTA_LABEL } from "@/lib/rolex-content";

// Authentic reviews, names, attribution, and business-wide trust metrics are
// reused verbatim from the shared content. Only the repeated CTA label is
// Rolex-specific; reviews are never rewritten to mention Rolex.
...
export function RolexReviews(): React.ReactElement {
  return (
